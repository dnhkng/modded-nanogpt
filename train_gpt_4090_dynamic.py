...
class DynamicHybridActivation(nn.Module):
...
class GPT(nn.Module):
    ...
    def __init__(self, vocab_size, num_layers, num_heads, model_dim):
        ...
        # Output activation function by #dnhkng
        self.output_activation = DynamicHybridActivation(alpha=0.5, temperature=1.0)
    def forward(self, inputs, targets, sliding_window_num_blocks):
        ...
        logits = logits.float()
        return self.output_activation.loss(logits, targets)
        # logits = logits.float()
